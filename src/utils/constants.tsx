export const SLUGS = {
  ...
  CKA: 'CKA',
  DOCKER_CONTAINER_TRANING: 'docker-container',
  AWS_Solutions_Architect_Associate: 'aws-soulution-architect-assoicate',
  DEVOPS: 'devops-certification-training-course',
  BCA_DEGREE_PROGRAM: 'bca-degree-program',
  MCA_DEGREE_PROGRAM: 'mca-degree-program',
  SUMMER_INTERNSHIP_TRANING: 'summer-internship-traning',
  WINTER_INTERNSHIP_TRANING: 'winter-internship-traning',
}
